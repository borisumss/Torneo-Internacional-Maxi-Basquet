...
from .models import  Estadisticas_enfrentamiento,Enfrentamiento ,Torneo, Inscripcion, Pre_Inscripcion,Categorias_Torneo, Organizador, Equipo, Entrenador, Jugador, Delegado, delegado_Inscripcion, delegado_PreInscripcion 
